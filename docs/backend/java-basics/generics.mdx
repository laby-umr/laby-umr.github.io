---
sidebar_position: 10
title: Java泛型（Generics）详解
description: 深入理解Java泛型的概念、语法、类型擦除、通配符与最佳实践
authors: [Laby]
last_update:
  date: 2025-08-07
  author: Laby
...
flowchart LR
    ...
    style 编译前 fill:#e0f7fa,stroke:#0097a7,stroke-width:1px
    style 编译后 fill:#e8f5e9,stroke:#2e7d32,stroke-width:1px
```
